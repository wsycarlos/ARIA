...
namespace PrefabEvolution
{
	...
	static class PEPrefabScriptExt
	{
		...
		static internal PEPrefabScript ReplaceInPlace(this PEPrefabScript _this, GameObject prefabObject, bool applyModifications = true, bool keepPrefabLink = true)
		{
			...
			foreach (var transformModification in _this.Modifications.NonPrefabObjects)
			{
				if (transformModification == null || transformModification.child == null || transformModification.parent == null)
					continue;
			...
			{
				newComponents.Add(nonPrefabComponent.child.CopyComponentTo(nonPrefabComponent.parent));
			}
