...
public class DownloadManager : MonoBehaviour 
{
	...
	IEnumerator Start() 
	{
		...
		//
		// Bundle Data
		TextAsset ta = initDataWWW.assetBundle.LoadAsset("BundleData") as TextAsset;
		bundles = JsonMapper.ToObject< List< BundleData > >(ta.text);
		foreach(var bundle in bundles)
			bundleDict.Add(bundle.name, bundle);

		// Build States
		ta = initDataWWW.assetBundle.LoadAsset("BuildStates") as TextAsset;
		...
		// BMConfiger
		ta = initDataWWW.assetBundle.LoadAsset("BMConfiger") as TextAsset;
