...
public class TestDownloadManager : MonoBehaviour 
{
	IEnumerator Start()
	{
		...
		yield return StartCoroutine( DownloadManager.Instance.WaitDownload("LA-A.assetBundle") );
		#pragma warning disable 0168
		var sceneBundle = DownloadManager.Instance.GetWWW("LA-A.assetBundle").assetBundle;
		...
		var workerObj = DownloadManager.Instance.GetWWW("AB-A.assetBundle").assetBundle.LoadAsset("worker");
		if(workerObj == null)
		...
		workerObj = DownloadManager.Instance.GetWWW("AA-A.assetBundle").assetBundle.LoadAsset("worker");
		if(workerObj == null)
		...
		var cube = DownloadManager.Instance.GetWWW("ACA.assetBundle").assetBundle.LoadAsset("Cube");
		var sphere = DownloadManager.Instance.GetWWW("ACB.assetBundle").assetBundle.LoadAsset("Sphere");
