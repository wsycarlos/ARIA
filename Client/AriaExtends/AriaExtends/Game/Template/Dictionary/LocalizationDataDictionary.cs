...
namespace Game.Template
{
    ...
    public class LocalizationDataDictionary : ITemplateDictionary
    {
        
        private System.Collections.Generic.List<LanguageVO> _itemlist;
        
        private System.Collections.Generic.Dictionary<int, LanguageVO> _itemdic;
        ...
        public virtual System.Collections.Generic.Dictionary<int, LanguageVO> ItemDic
        {
            get
            {
                return _itemdic;
        ...
        private void InitDictionary()
        {
            ...
            _itemdic = new System.Collections.Generic.Dictionary<int, LanguageVO>();
            for (int i = 0; (i < length); i = (i + 1))
            {
                try
                {
